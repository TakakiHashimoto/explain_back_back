...
> “A tutor that listens to how I explain something, identifies what I _think_ I understand but actually misunderstand, and makes me retrieve it again later.”
...
```json
{ "userId": "some-user-id", "title": "React" }
```
...
type Analysis = {
  ...
  questions: { question: string; targetConcept: string }[];
};
```
...
```json
{ "score": 91, "correct": true, "feedback": "You correctly explained..." }
```
